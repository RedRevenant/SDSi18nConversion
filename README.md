...
Currently works for version 3.2.0. <br />
...
Also, please give credit to me if you decide to translate SDS off of this! <br />
 <br />
A note: the default.json file is not as up to date as the split files, so if you decide to translate off this, use the split files! <br />
